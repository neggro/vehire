  ...
  return (
    <div className="container py-8">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight font-display">Mis favoritos</h1>
      ...
      {vehicles.length > 0 ? (
        ...
        <Card>
          <CardContent className="py-16 text-center">
            ...
            <h3 className="font-semibold text-lg mb-2">Sin favoritos</h3>
            <p className="text-muted-foreground mb-6">
              Explora vehículos y guarda tus favoritos para encontrarlos fácilmente
            </p>
            <Button asChild>
