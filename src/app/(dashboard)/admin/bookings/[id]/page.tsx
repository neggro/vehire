  ...
  return (
    <div className="container py-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        <h1 className="text-2xl font-bold">Reserva #{booking.id.slice(0, 8)}</h1>
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Comision plataforma</span>
            ...
            {booking.pickupLocation && (
              <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-muted-foreground">Lugar de recogida</p>
                    <p className="text-sm">{booking.pickupLocation}</p>
                  </div>
                  {booking.returnLocation && (
                    <div>
                      <p className="text-sm text-muted-foreground">Lugar de devolucion</p>
            ...
            {booking.status === "CANCELLED" && booking.cancellationReason && (
              <>
                ...
                <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900 rounded-md p-3">
                  <p className="text-sm font-medium text-red-800 dark:text-red-400 mb-1">Cancelada</p>
            ...
            {booking.payment ? (
              <div className="space-y-3">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Pago anfitrion</span>
                ...
                {booking.payment.paidAt && (
                  <p className="text-xs text-muted-foreground">
                    Pagado: {formatDate(booking.payment.paidAt)}
                  </p>
                )}
              </div>
            ) : (
          ...
          <Card className="lg:col-span-3">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Incidentes ({booking.incidents.length})
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
