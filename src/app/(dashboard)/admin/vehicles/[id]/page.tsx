...
export default function AdminVehicleDetailPage() {
  ...
  const handleStatusSave = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setStatusNotes("");
        toast({ title: "Estado del vehiculo actualizado" });
      } else {
  ...
  const featureLabels = VEHICLE_FEATURES.reduce<Record<string, string>>((acc, f) => {
    acc[f.id] = f.label;
    return acc;
  }, {});
    ...
    <div className="container py-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Transmision</p>
              ...
              <div>
                <p className="text-sm text-muted-foreground">Reserva instantanea</p>
                <p className="font-medium">{vehicle.instantBooking ? "Si" : "No"}</p>
              </div>
            </div>
            ...
            {vehicle.features.length > 0 && (
              <>
                ...
                <div>
                  <p className="text-sm text-muted-foreground mb-2">Caracteristicas</p>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Anfitrion</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <div className="flex justify-between">
                <span className="text-sm text-muted-foreground">Precio base/dia</span>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Gestion de estado</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <Label className="text-sm mb-2 block">Nuevo estado</Label>
