...
export function BookingCard({ vehicle }: BookingCardProps) {
  ...
  const t = useTranslations("vehicle.booking");
      ...
      <CardHeader>
        <div className="flex items-baseline justify-between">
          <div>
            ...
            <span className="text-muted-foreground">{tc("labels.perDay")}</span>
          </div>
          {vehicle.weekendPriceDay && (
            <span className="text-sm text-muted-foreground">
              {t("weekendPrice", { price: formatPrice(vehicle.weekendPriceDay) })}
            </span>
          )}
        </div>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="rounded-lg border p-3 space-y-2">
            <label className="text-xs font-medium text-muted-foreground">{t("pickup")}</label>
          ...
          {/* Return */}
          <div className="rounded-lg border p-3 space-y-2">
            <label className="text-xs font-medium text-muted-foreground">{t("return")}</label>
          ...
          <div className="space-y-2 border-t pt-4">
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">
                {t("days", { count: calculation.days })} × {formatPriceFromCents(calculation.dailyRate)}
              </span>
            ...
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">{t("depositGuarantee")}</span>
