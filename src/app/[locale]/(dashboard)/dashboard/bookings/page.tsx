...
export default function DriverBookingsPage() {
  ...
  const tStatus = useTranslations("common.bookingStatus");
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t("host", { name: booking.host?.fullName || "N/A" })}
                  </p>
                </div>
              ...
              <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1 text-sm text-muted-foreground">
                <div className="flex items-center gap-1">
                  ...
                  {format(new Date(booking.startDate), "d MMM", { locale: dateLocale })} -{" "}
                  {format(new Date(booking.endDate), "d MMM, yyyy", { locale: dateLocale })}
                </div>
                <div className="flex items-center gap-1">
    ...
    <div className="container max-w-4xl py-8">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="past">{t("history")}</TabsTrigger>
        </TabsList>
