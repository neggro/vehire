...
function SettingCard({ label, description, value, suffix, icon, onSave, editLabel, cancelLabel, min = 0, max = 999 }: SettingCardProps) {
    ...
    <div className="container py-8">
      ...
      <div className="space-y-4 max-w-3xl">
        ...
        <SettingCard
          ...
          description={t("weekendMarkupDesc")}
        ...
        <SettingCard
          ...
          description={t("minBookingDaysDesc")}
        ...
        />
        <SettingCard
          label={t("maxBookingDays")}
          description={t("maxBookingDaysDesc")}
