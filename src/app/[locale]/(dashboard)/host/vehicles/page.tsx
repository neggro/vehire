...
export default async function HostVehiclesPage() {
  ...
  const t = await getTranslations("host.vehicles");
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {vehicles.length > 0
              ? t("manageFleetCount", { count: vehicles.length })
              : t("manageFleet")}
          </p>
        </div>
        <Button asChild>
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-xs text-muted-foreground">
                {t("ofTotal", { total: vehicles.length })}
              </p>
            </CardContent>
          </Card>
          <Card>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {vehicle.city} · {vehicle.seats} {t("seats")} · {tCommon(`transmission.${vehicle.transmission.toLowerCase()}`)}
                        </p>
                      </div>
                      <Badge
                        variant={
