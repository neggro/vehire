  ...
  return (
    <Card className="w-full max-w-md border-border/40 shadow-2xl">
      <CardHeader className="text-center pb-2">
        ...
        <CardTitle className="text-2xl font-display">{t("title", { appName: APP_NAME })}</CardTitle>
        <CardDescription className="text-base">
          {t("subtitle")}
        </CardDescription>
      </CardHeader>
        ...
        <div className="max-w-md space-y-10">
          ...
          <div className="space-y-6">
            {[
              {
                icon: Car,
                title: t("vehicleVariety"),
                desc: t("vehicleVarietyDesc"),
              },
              {
                icon: Shield,
                title: t("fullyInsured"),
                desc: t("fullyInsuredDesc"),
              },
              {
                icon: Star,
                title: t("trustedCommunity"),
                desc: t("trustedCommunityDesc"),
              },
            ].map((item) => (
